...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            new TextCount().init({id:'company'}).render();
...
<jsp:include page="inc.jsp"></jsp:include>
   <form id="form1" action="/a/addStudent" enctype="multipart/form-data" method="post"  class="form-horizontal">
       <div class="control-group">
           <label class="control-label">图片：</label>
           <div class="controls">
               <div class="showred">(249*180)</div>
               <input type="file" name="file" id="files"><div class="btn btn-primary" type="button" onclick="upload()" id="upload" value="上传">上传</div>
               <img id="imgfile" ><br>
           </div>
       </div>
       <div class="control-group">
           <label class="control-label"> 就职公司：</label>
           <div class="controls">
