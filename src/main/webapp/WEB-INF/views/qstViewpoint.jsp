...
<div class="mainWrapper informationWrapper">
    ...
    <ul class="tabs">
        <a href="/media"><li>媒体聚焦</li></a>
        <a href="/newsInformation"><li class="">新闻资讯</li></a>
        <li class="active">青软观点</li>
        <a href="/concern"><li>各界关怀</li></a>
    </ul>
...
function getNewsList(currentPage){
	$.ajax({
		...
		data:"messageType=1&status=0&currentPage="+currentPage+"&pageSize=6",
		dataType:'json',
